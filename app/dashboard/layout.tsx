...
import { Search, Bell } from "lucide-react" // <--- Jangan lupa import icon Search
  ...
  return (
    <SidebarProvider>
      ...
      <main className="w-full bg-zinc-50/50 min-h-screen">
        {/* --- HEADER (Trigger Kiri, Search Kanan) --- */}
        <header className="flex h-16 items-center justify-between border-b bg-white px-4 shadow-sm">

          {/* Bagian Kiri: Tombol Buka/Tutup Sidebar */}
          <SidebarTrigger />

          {/* Bagian Kanan: Search Bar & Bell & Profile */}
          <div className="flex items-center gap-4">
            ...
            <button className="text-zinc-500 hover:text-zinc-800 transition-colors relative">
            ...
            <button className="flex items-center gap-2 hover:bg-zinc-100 p-1 pr-2 rounded-full transition-colors">
